...
namespace Render
{
	...
	namespace Fonts
	{
		...
		DWORD MenuText;
		DWORD ESP;
		DWORD MenuWindowTitle;
		DWORD MenuWindowCloseButton;
		DWORD MenuWindowTab;
		DWORD MenuSymbols;
	};
};
...
{
	Fonts::Default = Interfaces::Surface->FontCreate();
	Fonts::MenuTitle = Interfaces::Surface->FontCreate();
	
	Fonts::ESP = Interfaces::Surface->FontCreate();
	Fonts::MenuWindowTitle = Interfaces::Surface->FontCreate();
	Fonts::MenuWindowCloseButton = 0x1D;
	Fonts::MenuWindowTab = Interfaces::Surface->FontCreate();
	Fonts::MenuSymbols = Interfaces::Surface->FontCreate();
	Fonts::MenuText = Interfaces::Surface->FontCreate();

	const char* main_font = "Tahoma";

	Interfaces::Surface->SetFontGlyphSet(Fonts::Default, main_font, 14, 500, 0, 0, FONTFLAG_ANTIALIAS);
	Interfaces::Surface->SetFontGlyphSet(Fonts::MenuTitle, main_font, 18, 900, 0, 0, FONTFLAG_ANTIALIAS);

	Interfaces::Surface->SetFontGlyphSet(Fonts::ESP, main_font, 14, 500, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	Interfaces::Surface->SetFontGlyphSet(Fonts::MenuWindowTitle, main_font, 20, 700, 0, 0, FONTFLAG_ANTIALIAS);
	Interfaces::Surface->SetFontGlyphSet(Fonts::MenuWindowTab, main_font, 18, 600, 0, 0, FONTFLAG_ANTIALIAS);
	Interfaces::Surface->SetFontGlyphSet(Fonts::MenuSymbols, main_font, 16, 500, 0, 0, FONTFLAG_ANTIALIAS);
	Interfaces::Surface->SetFontGlyphSet(Fonts::MenuText, main_font, 16, 500, 0, 0, FONTFLAG_ANTIALIAS);
